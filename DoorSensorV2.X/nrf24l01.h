 ...
 * Author: Yayra Adugu
 *
 * Created on 21 November 2017, 15:42
 */
...
#define RF24_DPL_P0      (1<<0)
#define RF24_DPL_P1      (1<<1)
#define RF24_DPL_P2      (1<<2)
#define RF24_DPL_P3      (1<<3)
#define RF24_DPL_P4      (1<<4)
#define RF24_SPL_P5      (1<<5)

#define RF24_EN_DPL      (1<<2)
#define RF24_EN_ACK_PAY  (1<<1)
#define RF24_EN_DYC_ACK  (1<<0)
/* Bit Mnemonics */
